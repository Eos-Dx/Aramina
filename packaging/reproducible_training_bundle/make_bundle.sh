...
BUNDLE_NAME="aramis_docker_training_bundle_0_2_13_beta"
AMD64_IMAGE_TAG="eosdx/aramis-training:0.2.13-beta-amd64"
AMD64_IMAGE_ARCHIVE="aramis_training_linux_amd64_0_2_13_beta.tar"
ARM64_IMAGE_TAG="eosdx/aramis-training:0.2.13-beta-arm64"
ARM64_IMAGE_ARCHIVE="aramis_training_linux_arm64_0_2_13_beta.tar"
...
cp "${ARAMIS_ROOT}/config/preprocessing/aramis_prediction_patient_model_input_v0_1.yaml" \
  "${WORK_DIR}/config/preprocessing/"
cp "${ARAMIS_ROOT}/config/preprocessing/cohorts/biopsy_patients_normal_as_benign_v0_1.yaml" \
  "${WORK_DIR}/config/preprocessing/cohorts/"
cp "${ARAMIS_ROOT}/config/preprocessing/cohorts/prediction_patient_v0_1.yaml" \
  "${WORK_DIR}/config/preprocessing/cohorts/"
...
payload = {
    ...
    "image_amd64_tag": "eosdx/aramis-training:0.2.13-beta-amd64",
    "image_amd64_platform": "linux/amd64",
    "image_amd64_archive": "aramis_training_linux_amd64_0_2_13_beta.tar",
    "image_amd64_archive_sha256": digest(amd64_image_path),
    "image_arm64_tag": "eosdx/aramis-training:0.2.13-beta-arm64",
    "image_arm64_platform": "linux/arm64",
    "image_arm64_archive": "aramis_training_linux_arm64_0_2_13_beta.tar",
