# Araminavisor Demonstrator Bundle
...
```text
Aramina prediction API -> owns model.joblib and preprocessing contract
Araminavisor Streamlit platform -> selects a patient, sends one H5 to API, renders reports
```
...
```bash
cd aramina_demo_bundle_0_2_12_beta
bash ./start_demo.sh \
...
```powershell
Set-Location aramina_demo_bundle_0_2_12_beta
.\start_demo.ps1 `
