...
Copy-OrUpdateRepo "Aramis" "https://github.com/Eos-Dx/Aramis.git" (Join-Path $TargetRoot "Aramis") "examples\prediction_models\aramis_m2q_t100_core4_c1_0p1_c2_0p1.joblib" "0.1.8-beta"
