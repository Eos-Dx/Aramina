...
case "$(uname -m)" in
  arm64|aarch64)
    IMAGE_TAG="eosdx/aramis-prediction-api:0.2.10-beta-arm64"
    IMAGE_ARCHIVE="${SCRIPT_DIR}/aramis_prediction_api_linux_arm64_0_2_10_beta.tar"
    ;;
  x86_64|amd64)
    IMAGE_TAG="eosdx/aramis-prediction-api:0.2.10-beta-amd64"
    IMAGE_ARCHIVE="${SCRIPT_DIR}/aramis_prediction_api_linux_amd64_0_2_10_beta.tar"
    ;;
  *)
