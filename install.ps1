...
if (-not $SkipExample) {
    $PredictYaml = Join-Path $RepoDir "examples\prediction_h5\cancer_predict.yaml"
...
Write-Host "  python -m aramis predict --config examples\prediction_h5\cancer_predict.yaml"
