...
def _():
    ...
    import aramis_agbh_kbeta_helpers as agbh_helpers

    agbh_helpers = importlib.reload(agbh_helpers)

    PRODUCT_DIR = Path(__file__).resolve().parent
    BASE_DIR = PRODUCT_DIR.parents[1]
    DATA_DIR = BASE_DIR / "data" / "product-aramis-data"
    CALIBRATION_DIR = DATA_DIR / "calibration"
    OUT_DIR = BASE_DIR / "analysis" / "aramis_agbh_kbeta_shoulder_metric"
    LEFT_OUT_DIR = BASE_DIR / "analysis" / "aramis_agbh_kbeta_left_metric"
