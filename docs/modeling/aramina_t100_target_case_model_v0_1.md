# Aramina T100 Target-Case Model v0.1
...
This document fixes the current Aramina model architecture and its current
...
```text
Aramina T100 is a research-draft decision-support model, not a clinical-validation claim.
...
`aramina_sk_symmetry_v0_2` feature contract and was evaluated on the T100 biopsy-patient cohort
