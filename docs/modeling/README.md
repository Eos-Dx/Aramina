...
frozen product artifact. The `0.2.13-beta` no-DVC candidate and `0.2.14-beta`
DVC-tracked candidate are retained for comparison; experimental candidates and
model-selection tables remain on experiment branches.
