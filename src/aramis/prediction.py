"""Public prediction entrypoint for Aramis research-draft decision support."""
...
def run_prediction_from_config(config_path: str | Path) -> dict[str, Any]:
    """Run one H5-backed, one-patient Aramis prediction from YAML."""
...
def _prediction_dataframe(
    ...
    validate_aramis_preprocessing_config(preprocessing_config)
